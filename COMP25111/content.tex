...
that is being transferred (the data is transfered in blocks), and the other
...
speed of the processor, and the maximum througput of the data we \textit{could}
...
\begin{description}
  \item \textbf{Software interrupt}\\
    ...
    program to handle this. These instructions are noramlly used when there is
