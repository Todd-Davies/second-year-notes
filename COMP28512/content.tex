...
\begin{description}
  \item \textbf{Repeating bits}:\\
    ...
    majority of the recieved bits, and the one error bit would be ignored.
...
remainder, then we know that a bit error has occured.
...
efficiency and effectivness of the system. Transmitting at higher power is one
...
Where $B$ is the bandwidth in $\si{\hertz}$, and $\frac{S}{N}$ is the signal to noise power ratio
